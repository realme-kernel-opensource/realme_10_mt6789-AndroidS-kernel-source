...
#define DW9718AF_NAME				"dw9718p_22021"
...
#define DW9718_MIN_CODE              130
#define DW9718AF_RELEASE_STEPS		 20
#define DW9718AF_RELEASE_10MS	 	10000
#define DW9718AF_RELEASE_1MS	 	1000
...
static int dw9718af_release(struct dw9718af_device *dw9718af)
{
	...
	usleep_range(DW9718AF_RELEASE_1MS, DW9718AF_RELEASE_1MS + 100);
	dw9718af_set_position(dw9718af, 160);
	usleep_range(DW9718AF_RELEASE_1MS, DW9718AF_RELEASE_1MS + 100);
	val = 160;
	while (val > DW9718_MIN_CODE) {
		...
		usleep_range(DW9718AF_RELEASE_10MS, DW9718AF_RELEASE_10MS + 100);
	}
