...
#include "oplus22021_boe_rm692e5_fhd_dsi_cmd.h"
#include "oplus_bl.h"
//#ifdef OPLUS_ADFR
			...
			enum MTK_PANEL_MODE_SWITCH_STAGE stage, dcs_write_gce_pack cb)
{
	...
	if (stage == BEFORE_DSI_POWERDOWN) {
        ...
        if (mode_id == FHD_SDC60) {
			...
			DISP_INFO("timing switch to FHD_SDC90\n");
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "RM692E5_BOE", "BOE4095");
	oplus_max_normal_brightness = SILKY_MAX_NORMAL_BRIGHTNESS;

	DISP_INFO("- lcm,rm692e5,vdo,60hz, adfrconfig=%d\n", oplus_adfr_config);
...
static const struct of_device_id lcm_of_match[] = {
	{
	    .compatible = "oplus22021_boe_rm692e5_fhd_dsi_cmd",
	},
	{}
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus22021_boe_rm692e5_fhd_dsi_cmd",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("lcm rm692e5 Panel Driver");
